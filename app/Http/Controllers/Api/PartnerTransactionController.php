...
{
    /**
     * Adds a new purchase to a card owned by the authenticated partner.
     *
     * @OA\Post(
     *     path="/{locale}/v1/partner/cards/{cardUID}/{memberUID}/transactions/purchases",
     *     operationId="addPurchase",
     *     tags={"Partner", "Transaction", "Card", "Staff"},
    ...
    /**
     * Adds new points to a card owned by the authenticated partner.
     *
     * @OA\Post(
