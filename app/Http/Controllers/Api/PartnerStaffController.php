...
{    
    /**
     * Returns all active staff members associated with the authenticated partner, where the associated club is also active.
     *
     * @OA\Get(
    ...
    /**
     * Returns the details of a specific active staff member identified by the staffId for an authenticated partner, where the associated club is also active.
     *
     * @OA\Get(
