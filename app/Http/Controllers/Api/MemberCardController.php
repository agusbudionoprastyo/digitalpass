...
{
    /**
     * Retrieves all cards a specific member follows and has transacted with,
     * ordered by member balance and issue date in descending order.
     *
     * @OA\Get(
    ...
    /**
     * Retrieves all active cards a specific member follows.
     *
     * @OA\Get(
    ...
    /**
     * Retrieves all active cards a specific member has transacted with.
     *
     * @OA\Get(
    ...
    /**
     * Get the balance of the authenticated member for a specific card.
     *
     * @OA\Get(
