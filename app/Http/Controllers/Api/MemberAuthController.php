...
class MemberAuthController extends Controller
{
     ...
     *
     * The endpoint ("/{locale}/v1/member/register") allows for new member account creation.
     * Several parameters are available to configure the account during its creation.
     * 
     * @OA\Post(
     ...
     * Log out a member.
     *
     * The endpoint ("/{locale}/v1/member/logout") revokes all access tokens for the authenticated member.
     *
     * @OA\Post(
     ...
     * Get member data.
     *
     * The endpoint ("/{locale}/v1/member") retrieves the data of the authenticated member.
     * 
     * @OA\Get(
