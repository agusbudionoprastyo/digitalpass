...
return [
    ...
    */
    ...
    "login_block_text" => [
        ...
        "We're thrilled to have you join and voucher your loyalty!",
    ],
    ...
    */
    ...
    "no_reward_found" => "We're sorry, but this voucher cannot be found.",
    ...
    */
    ...
    "reward_points_text" => "The number of points a member needs to accumulate in order to redeem this voucher.",
    "reward_is_active_text" => "Inactive rewards are not visible on the website.",
    "main_image" => "Main image",
    "images" => "Images",
    "image_no" => "Image :number",
    "claim_reward" => "Claim voucher",
    "you_have_amount_points" => "You have :points points.",
    "you_need_amount_more" => "You need :points more points to claim this voucher.",
    "you_need_more_points" => "You need more points to claim this voucher.",
    "you_have_amount_after" => "After claiming this voucher, you have :points points remaining.",
    ...
    */
    ...
    "log_in_to_claim_reward" => "Log in to claim voucher",
    "claim" => "Claim",
    "member_not_enough_points_for_reward" => "The member does not have enough points for this voucher",
    ...
    */
    ...
    "staff_login_block_text" => [
        "Welcome to your hub for customer engagement. Seamlessly manage loyalty points and process voucher redemptions with ease.",
    ],
    ...
    "redeem_points_for_reward" => "Redeem points for voucher",
    ...
    */
    ...
    "last_reward_claimed" => "Last voucher claimed",
    ...
    "sort_by_most_recently_claimed_reward" => "Sort by most recently claimed voucher",
    "sort_by_least_recently_claimed_reward" => "Sort by least recently claimed voucher",
    ...
    */
    ...
    "registration_body" => "Password anda adalah :password.",
    "registration_subcopy" => "Setelah Login, Anda dapat mengubah kata sandi ini. Jika Anda belum meminta kata sandi ini, Anda tidak perlu melakukan tindakan lebih lanjut.",
    ...
    // Reward claimed
    "reward_claimed_subject" => "You claimed a voucher - :reward_title",
    "reward_claimed_body" => "Thanks for your loyalty. You've claimed your voucher: :reward_title for :points loyalty points.",
    "reward_claimed_cta" => "See claimed voucher",
